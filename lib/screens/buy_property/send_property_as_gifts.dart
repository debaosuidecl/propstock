...
class SendPropertyAsGift extends StatefulWidget {
  static const id = "send_property_as_gift";

  const SendPropertyAsGift({super.key});

  @override
  State<SendPropertyAsGift> createState() => _SendPropertyAsGiftState();
}

class _SendPropertyAsGiftState extends State<SendPropertyAsGift> {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Who do you want to give this property?",
                  style: TextStyle(
                    fontFamily: "Inter",
                    fontWeight: FontWeight.w600,
                    fontSize: 18,
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("Add the person you’d like to gift this property ",
                            style: TextStyle(
                              color: MyColors.neutralGrey,
                            ))
                      ],
