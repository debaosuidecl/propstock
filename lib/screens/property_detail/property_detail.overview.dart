...
class PropertyDetailOverview extends StatefulWidget {
  ...
  @override
  State<PropertyDetailOverview> createState() => _PropertyDetailOverviewState();
}

class _PropertyDetailOverviewState extends State<PropertyDetailOverview> {
  int imageIndex = 0;
  @override
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 10),
                child: PropertyMoreInformation(property: widget.property),
              ),
              const SizedBox(
                height: 50,
              ),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 10),
                child: PropertyMoreDocuments(property: widget.property),
              ),
              const SizedBox(
                height: 50,
              ),
