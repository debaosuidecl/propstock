...
class CoBuyModal extends StatefulWidget {
  const CoBuyModal({super.key});

  @override
  State<CoBuyModal> createState() => _CoBuyModalState();
}

class _CoBuyModalState extends State<CoBuyModal> {
  bool _loading = true;
