...
class PendingPaymentInvestmentNotification extends StatelessWidget {
  final NotificationModel notif;
  final void Function(String?)? execute;

  const PendingPaymentInvestmentNotification(
            ...
            children: [
              ...
              Container(
                ...
                child: RichText(
                  text: TextSpan(
                    text:
                        'You have a pending Payment to make on this investment. Deadline for payment is ',
                    style: TextStyle(
                      fontSize: 14,
