...
class PinToWithdrawToBank extends StatefulWidget {
  PinToWithdrawToBank({
    super.key,
  });

  @override
  State<PinToWithdrawToBank> createState() => _PinToWithdrawToBankState();
}

class _PinToWithdrawToBankState extends State<PinToWithdrawToBank> {
  // Property? _property;
  bool loading = false;
  bool _success = false;
  ...
  void _initPinManagement() {
    ...
    _userInvestment = Provider.of<InvestmentsProvider>(context, listen: false)
        .selectedInvestment;
    _userBankAccount = Provider.of<InvestmentsProvider>(context, listen: false)
        .selectedBankAccount;
    _amountToWithdraw = Provider.of<InvestmentsProvider>(context, listen: false)
        .amountToWithdraw;
    setState(() {});
  }
            ...
            child: _success
                ...
                : Column(
                    children: [
                      ...
                      Row(
                        children: [
                          GestureDetector(
                            onTap: () {
                              Navigator.pop(
                                  context, "propstock_wallet_withdraw");
                            },
                            child: Icon(
                      ...
                      Text(
                        "Enter your four digit transaction PIN to complete your withdrawal",
                        style: TextStyle(
                          color: MyColors.neutralGrey,
                          fontSize: 16,
                          fontFamily: "Inter",
                            ...
                            onPressed: () async {
                              ...
                              try {
                                ...
                                await Provider.of<PaymentProvider>(context,
                                        listen: false)
                                    .setWithdrawalRequestOnInvestment(
                                        _pinController.text,
                                        _userBankAccount,
                                        _amountToWithdraw,
                                        _userInvestment);
