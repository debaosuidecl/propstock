...
class SelectABank extends StatefulWidget {
  @override
  State<SelectABank> createState() => _SelectABankState();
}

class _SelectABankState extends State<SelectABank> {
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return GestureDetector(
                              onTap: () {
                                ...
                                Navigator.pop(context, "pin_to_bank");
                              },
                              child: Column(
                                children: [
                                  ListTile(
