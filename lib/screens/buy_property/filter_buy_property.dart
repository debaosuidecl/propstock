...
class FilterBuyProperty extends StatefulWidget {
  static const id = "filter_buy";
  const FilterBuyProperty({super.key});

  @override
  State<FilterBuyProperty> createState() => _FilterBuyPropertyState();
}

class _FilterBuyPropertyState extends State<FilterBuyProperty> {
  ...
  void initSelections() {
    setState(() {
      ...
      values = RangeValues(
          Provider.of<BuyPropertyProvider>(context, listen: false).minPrice *
              Provider.of<BuyPropertyProvider>(context, listen: false).factor,
          Provider.of<BuyPropertyProvider>(context, listen: false).maxPrice *
              Provider.of<BuyPropertyProvider>(context, listen: false).factor);
    });
  ...
  Widget build(BuildContext context) {
    ...
    var currencyFormatter = NumberFormat.currency(
        locale: 'en_US',
        symbol:
            Provider.of<BuyPropertyProvider>(context, listen: true).currency);
