...
class EnterPinPrePurchaseBuy extends StatefulWidget {
  EnterPinPrePurchaseBuy({
    super.key,
  });

  @override
  State<EnterPinPrePurchaseBuy> createState() => _EnterPinPrePurchaseBuyState();
}

class _EnterPinPrePurchaseBuyState extends State<EnterPinPrePurchaseBuy> {
  Property? _property;
  bool loading = false;
  int _quantity = 0;
  bool _success = false;
                ...
                ? Center(
                    child: Column(
                      children: [
                        ...
                        Text(
                          "You can find your property in your assets ",
                          style: TextStyle(
