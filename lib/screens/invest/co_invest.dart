...
class CoInvest extends StatefulWidget {
  static const id = "co_invest";

  const CoInvest({super.key});

  @override
  State<CoInvest> createState() => _CoInvestState();
}

class _CoInvestState extends State<CoInvest> {
                        ...
                        return GestureDetector(
                          onTap: () {
                            if (_selectedUsers.keys.length >= 4) {
                              showErrorDialog(
                                  "You can only add 4 co-investors", context);
                              return;
                            } else {
                              setState(() {
