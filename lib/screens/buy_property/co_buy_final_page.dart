...
import 'package:propstock/screens/buy_property/co_buy_modal.dart';
...
class CoBuyFinalPage extends StatefulWidget {
  final Property? property;
  const CoBuyFinalPage({super.key, this.property});
  static const id = "CoBuyFinalPage";
  @override
  State<CoBuyFinalPage> createState() => _CoBuyFinalPageState();
}
...
class _CoBuyFinalPageState extends State<CoBuyFinalPage> {
  int _number = 1;
  // User? _friendToGift;
  int _payment_page = 0;
  ...
  void dispose() {
    ...
    super.dispose();
    // final state = _key.currentState as _CoBuyFinalPageState?;
  }
